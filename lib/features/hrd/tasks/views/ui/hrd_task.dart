...
class HrdTask extends GetView<HrdTaskController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.groupedTasks.isEmpty) {
          return Center(
            child: Column(
        ...
        final userNames = controller.groupedTasks.keys.toList();
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final userTasks = controller.groupedTasks[userName]!;
